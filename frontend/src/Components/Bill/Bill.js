...
useEffect((i)=>{
  ...
  return (
    ...
    <Navbar billing="Billing"/>
      ...
      <Typography variant="h5" sx={{p:'10px'}}>Table No. - {tableNo}  
      <img src='https://cdn-icons-png.flaticon.com/512/1889/1889949.png' width='50px'  hspace="15"/></Typography>
      
      <Typography variant="h5" sx={{p:'10px'}}>Bill - ₹ {bill}/- 
      <img src='https://cdn-icons-png.flaticon.com/512/1052/1052866.png' width='40px' vspace="-5" hspace="5"/></Typography>

      <Typography variant="h5" sx={{p:'10px'}}>Items - {items+1} 
      <img src='https://cdn-icons-png.flaticon.com/512/4290/4290854.png' width='35px'  hspace="5"/></Typography>

      </div>
     

      <div className="bill-card">
            <Stack spacing={2} direction='row' sx={{p:'10px',}} className='bill-stack' >
               {myBill.map((x,i)=>(

               
                
                <Card sx={{ display: 'flex', boxShadow:'15' }} className='bill-card' >
        ...
        <div className="bill-button">
            ...
            <Button variant="contained" onClick={Unbook} color='success'>Proceed to Payment</Button>
        </div>
    </div>
  );
};
